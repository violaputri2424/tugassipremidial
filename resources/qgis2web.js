...
map.getView().fit([12547333.246849, -936113.903647, 12641625.623705, -877349.716392], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA KETERJANGKAUAN RUMAH SAKIT DI KABUPATEN LUMAJANG</h2>';
        return titleElement;
    })(),
